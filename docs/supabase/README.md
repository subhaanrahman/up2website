...
| Doc | Purpose |
|-----|---------|
| [MIGRATION_AND_HOSTING.md](MIGRATION_AND_HOSTING.md) | **Main ops guide:** Sydney status, env/secrets (including Digital ID Apple/Google Wallet), Stripe webhook, GitHub Actions, MCP, future region migration, migration-history troubleshooting |
...
**Whole-repo backlog (not Supabase-only):** [../PLATFORM_TODOS.md](../PLATFORM_TODOS.md).
