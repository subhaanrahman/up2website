...
export function CtaBand({ id = "cta-download", heading, body, primary, secondary }: CtaBandProps) {
  return (
    <section id={id} className="border-b border-border/60 bg-gradient-to-br from-primary/15 via-background to-background py-20 md:py-24">
      <div className="container">
        <div className="mx-auto max-w-3xl rounded-tile border border-border/70 bg-card/40 p-10 text-center shadow-lg backdrop-blur-md md:p-14">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            ...
            {secondary ? (
              <Button asChild variant="outline" size="lg" className="min-h-12 border-border/80 bg-background/40 px-8 backdrop-blur-sm">
